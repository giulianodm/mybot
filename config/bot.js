...
var CONVERSATION_NAME = "mybot"; // conversation name goes here.
...
function initConversation() {
    var conversationCredentials =  appEnv.services.conversation[0].credentials || appEnv.getServiceCreds('mybot'); // Get credentials from env. on bluemix, otherwise get it locally
